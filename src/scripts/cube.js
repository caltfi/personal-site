...
const materials = [
    new THREE.MeshBasicMaterial({ map: loader.load('/assets/images/portfolio.png') }),
    new THREE.MeshBasicMaterial({ map: loader.load('/assets/images/contact.png') }),
    new THREE.MeshBasicMaterial({ map: loader.load('/assets/images/about.png') }),
    new THREE.MeshBasicMaterial({ map: loader.load('/assets/images/resume.png') }),
    new THREE.MeshBasicMaterial({ map: loader.load('/assets/images/laptop_cube.png') }), //front
    new THREE.MeshBasicMaterial({ map: loader.load('/assets/images/logo_cube.png') })         //back
  ];
